...
<head>
  ...
  <link rel="shortcut icon" type="image/png" href="https://www.hul.ac.uk/site-elements/img/favicon/favicon-57.png"/>
...
if (empty($_GET["StudentID"])) {
							 ...
							 $StudentID = est_input($_GET["StudentID"]);
...
{
$Fetch="SELEC * FROM TEMP WHERE StudentID LIKE '$StudentID' AND booking_for > (SELECT DATE_ADD(CURDATE(), INTERVAL - WEEKDAY(CURDATE()) DAY))  ORDER BY `temp`.`booking_for` ASC";
$result = mysqli_query($conn, $Fetch);
}
